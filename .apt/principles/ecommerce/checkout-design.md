...
- [apt-checkout-reviewer](../../agents/ecommerce/apt-checkout-reviewer.md) — Use when a checkout flow — cart, payment entry, confirmation — needs review for conversion friction and correctness.
