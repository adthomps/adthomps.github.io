...
const populateFormFieldsArray = () => {
    const formFields = [
        ...
        { type: "input", id: "x_description", value: "SIM Test Production - OCE", sendit: "1", locked: true },
        ...
        { type: "input", id: "x_receipt_link_method", value: "get", sendit: "1" },
        { type: "input", id: "x_receipt_link_text", value: "Receipt Link", sendit: "1" },
        { type: "input", id: "x_receipt_link_url", value: "https://anetreceiptpageget.apt-account.workers.dev/", sendit: "1" },
