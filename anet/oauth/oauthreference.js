        ...
        <main>
            ...
            <div class="container">
                ...
                <div class="px-4 py-0 my-5 text-center">
                    <h1 class="display-8 fw-bold">OAuth Test</h1>
                    <div class="d-flex justify-content-center">
                        <p class="lead mb-4">OAuth</p>
                    </div>
                    ...
                    <div class="row g-5">
                        ...
                        <div class="col-md-5 col-lg-10 order-md-last">
                            <h4 class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-primary">OAuth Data</span>
                            </h4>
                            <ul class="list-group mb-3">
                            
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <div>
                                        <h6 class="my-0">OAuth Code</h6>
                                        <small class="text-body-secondary" id="code">${code}</small>
                                </li>
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <!--<div>
                                        <h6 class="my-0">OAuth State</h6>
                                        <small class="text-body-secondary" id="code">${state}</small>
                                    </div>-->
                                </li>
                            </ul>
